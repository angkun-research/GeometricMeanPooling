...
from models.cnn import DeepCNNLocal
from tasks.mnist import make_dataloaders, train_one_epoch, evaluate
from utils import pick_best_device, set_seed

def run_config2(pooling: str, epochs=100, lr=0.001, batch_size=128, seed=42):
    print(f"\n--- Running Config 2 (Local Coarse-Graining) with Pooling: {pooling} ---")
    ...
    model = DeepCNNLocal(pooling=pooling).to(device)
...
if __name__ == "__main__":
    ...
    print("\n" + "="*30)
    print("Config 2 Results (Accuracy):")
